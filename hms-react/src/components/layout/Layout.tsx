...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#0a0c12] relative">
      <div className="fixed top-0 left-0 w-[600px] h-[600px] rounded-full pointer-events-none -z-10 bg-[radial-gradient(circle,rgba(79,152,163,0.07)_0%,transparent_70%)]" />
      ...
      <div className={`fixed inset-y-0 left-0 z-50 transform transition-transform duration-250 ease-in-out md:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <Sidebar className="flex" />
      </div>

      <div className="flex-1 flex flex-col ml-0 w-full md:ml-[220px]">
